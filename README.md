...
- **AI/ML:** TensorFlow, Keras, OpenCV, Deep Learning, Computer Vision, Explainable AI (XAI) 
- **Cloud & Dev Tools:** Git, GitHub, Postman, VS Code, AWS (Basics), Azure (Basics)
---

## 📌 Featured Projects  

- 🧠 **[XAI-Driven Hybrid DL for Brain Tumor & Alzheimer's Detection](https://github.com/gdvarshu/XAI-Driven-Hybrid-DL-for-BrainTumor-and-Alzheimers)**  
  An Explainable AI (XAI) powered hybrid deep learning framework for detecting and classifying Brain Tumor, Alzheimer's Disease, and Healthy MRI scans using ResNet50, ensemble learning, and Grad-CAM visualization.
